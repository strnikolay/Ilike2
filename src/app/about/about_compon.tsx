  ...
  return (
    ...
    <div className="about-wrapper container">
            ...
            <div className="about-item">
                <Image src="/about/ico_about1.png" fill alt=""/>
            ...
            <div className="about-item">
                <Image src="/about/ico_about2.png" fill alt=""/>
                <div className="about-content">   
            ...
            <div className="about-item">
                <Image src="/about/ico_about3.png" fill alt=""/>
                <div className="about-content"> 
            ...
            <div className="about-item">
                <Image src="/about/ico_about4.png" fill alt=""/>
